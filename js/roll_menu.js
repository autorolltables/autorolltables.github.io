    ...
    items: [
      ...
      },
      {
        ...
        main_rolls: [
          ...
          "wilderness/d6discoverywhenwasthecontinentwasdiscovered_continent",
      ...
      {
        title: "Random Deep Class",
        use:
          "A whole character class, blended out of the traditional ones the way a compass blends its points: two bearings are rolled and mixed, and a third quarter turn arrives by chance, which is where north north west comes from. Every property is a table, from hit die and saves to the resource it spends, and all twenty levels roll, with subclass features at 3, 6, 10 and 14 and an alternative to the ability score increase at 4, 8, 12, 16 and 19.",
        main_rolls: [
          "classes/d20firstbearing_classes",
          "classes/d20secondbearing_classes",
          "classes/d12mix_classes",
          "classes/d20namefirst_classes",
          "classes/d20namesecond_classes",
          "classes/d8hitdie_classes",
          "classes/d12abilities_classes",
          "classes/d10saves_classes",
          "classes/d12armour_classes",
          "classes/d12weapons_classes",
          "classes/d12skills_classes",
          "classes/d12kit_classes",
          "classes/d16resource_classes",
          "classes/d12recovery_classes",
          "classes/d12level01_classes",
          "classes/d12level02_classes",
          "classes/d12level03_classes",
          "classes/d10level04_classes",
          "classes/d12level05_classes",
          "classes/d10level06_classes",
          "classes/d10level07_classes",
          "classes/d10level08_classes",
          "classes/d10level09_classes",
          "classes/d10level10_classes",
          "classes/d10level11_classes",
          "classes/d10level12_classes",
          "classes/d10level13_classes",
          "classes/d10level14_classes",
          "classes/d10level15_classes",
          "classes/d10level16_classes",
          "classes/d10level17_classes",
          "classes/d10level18_classes",
          "classes/d10level19_classes",
          "classes/d12level20_classes",
          "classes/d10regard_classes",
        ],
        pick_rolls: [
          "classes/d10traditionhall_classes",
          "classes/d10traditionlodge_classes",
          "classes/d10traditiontemple_classes",
          "classes/d10traditioncollege_classes",
          "classes/d10traditionoutfit_classes",
          "classes/d10traditionnone_classes",
        ],
        sub_rolls: [
          "classes/gatebranches_classes",
          "classes/gatetaboo_classes",
          "classes/gatethird_classes",
          "classes/gatesignature_classes",
          "classes/gaterival_classes",
          "classes/gatecost_classes",
          "classes/gatemulticlass_classes",
          "classes/gatesecret_classes",
        ],
      },
      {
        title: "Random Magic Item (Deep)",
        use:
          "A whole magic item from one click: form, name, powers and provenance always; history, quirks, curses, seekers, sentience and stranger things by chance. Most items are modest. Roll enough of them and one will wake up and start talking.",
        main_rolls: [
          "magicitems/d20namefirst_magicitems",
          "magicitems/d20namesecond_magicitems",
          "magicitems/d20material_magicitems",
          "magicitems/d20appearance_magicitems",
          "magicitems/d12touch_magicitems",
          "magicitems/d16activation_magicitems",
          "magicitems/d30primarypower_magicitems",
          "magicitems/d12rarityvalue_magicitems",
          "magicitems/d12condition_magicitems",
          "magicitems/d16provenance_magicitems",
        ],
        pick_rolls: [
          "magicitems/d12formweapon_magicitems",
          "magicitems/d10formarmour_magicitems",
          "magicitems/d12formjewellery_magicitems",
          "magicitems/d10formtool_magicitems",
          "magicitems/d10forminstrument_magicitems",
          "magicitems/d10formvessel_magicitems",
          "magicitems/d10formgarment_magicitems",
          "magicitems/d12formcurio_magicitems",
        ],
        sub_rolls: [
          "magicitems/gatehistory_magicitems",
          "magicitems/gatequirk_magicitems",
          "magicitems/gatesecondary_magicitems",
          "magicitems/gatecost_magicitems",
          "magicitems/gateattunement_magicitems",
          "magicitems/gatecurse_magicitems",
          "magicitems/gatewanted_magicitems",
          "magicitems/gatesentience_magicitems",
          "magicitems/gatelegendary_magicitems",
          "magicitems/gatebecoming_magicitems",
        ],
      },
      {
      ...
      },
      {
        title: "Random Skill",
        use:
          "An invented technique for a character: what it does, how it is performed, what it costs and what it leaves behind. Thirteen facets are rolled independently, so two skills are almost never alike.",
        main_rolls: [
          "skills/d20skillnamefirst_skills",
          "skills/d20skillnamesecond_skills",
          "skills/d16discipline_skills",
          "skills/d20effect_skills",
          "skills/d20performance_skills",
          "skills/d16cost_skills",
          "skills/d20drawback_skills",
          "skills/d10reach_skills",
          "skills/d10duration_skills",
          "skills/d16origin_skills",
          "skills/d20tell_skills",
          "skills/d12mastery_skills",
          "skills/d20quirk_skills",
        ],
        sub_rolls: [],
      },
      {
      ...
      },
      {
        ...
        use:
          "One roll picks an environment, a second draws a hook from that environment's list. The list it landed on is named with the result. Roll the sub-tables below directly to stay in one environment.",
        main_rolls: [],
        sub_rolls: [],
        pick_rolls: [
          "plots/d50arctic_plothooks",
          "plots/d50coastal_plothooks",
          "plots/d50desert_plothooks",
          "plots/d50jungle_plothooks",
          "plots/d100miscellaneous_plothooks",
          "plots/d50mountain_plothooks",
          "plots/d50ocean_plothooks",
          "plots/d121urban_plothooks",
        ],
      },
      {
        title: "- Plot Hooks - Arctic",
        use: "Roll a single plot hook for a arctic setting.",
        main_rolls: ["plots/d50arctic_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Coastal",
        use: "Roll a single plot hook for a coastal setting.",
        main_rolls: ["plots/d50coastal_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Desert",
        use: "Roll a single plot hook for a desert setting.",
        main_rolls: ["plots/d50desert_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Jungle",
        use: "Roll a single plot hook for a jungle setting.",
        main_rolls: ["plots/d50jungle_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Miscellaneous",
        use: "Roll a single plot hook for any setting.",
        main_rolls: ["plots/d100miscellaneous_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Mountain",
        use: "Roll a single plot hook for a mountain setting.",
        main_rolls: ["plots/d50mountain_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Ocean",
        use: "Roll a single plot hook for a ocean setting.",
        main_rolls: ["plots/d50ocean_plothooks"],
        sub_rolls: [],
      },
      {
        title: "- Plot Hooks - Urban",
        use: "Roll a single plot hook for a urban setting.",
        main_rolls: ["plots/d121urban_plothooks"],
        sub_rolls: [],
      },
      {
        title: "Random Potion",
        use:
          "A whole bottle from one click: the vessel, the liquid and how it moves, the smell, the taste, the label somebody wrote and what it really does. Side effects, sediment, bad reactions, cravings, delayed doses and the brewer's story arrive by chance. Not every bottle is what the label says, and one in twelve is not a potion at all.",
        main_rolls: [
          "potions/d20liquid_potions",
          "potions/d16behaviour_potions",
          "potions/d16smell_potions",
          "potions/d16taste_potions",
          "potions/d12stopper_potions",
          "potions/d16label_potions",
          "potions/d30effect_potions",
          "potions/d12onset_potions",
          "potions/d12duration_potions",
          "potions/d10doses_potions",
          "potions/d12worth_potions",
          "potions/d16brewer_potions",
        ],
        pick_rolls: [
          "potions/d12vesselglass_potions",
          "potions/d10vesselclay_potions",
          "potions/d10vesselmetal_potions",
          "potions/d10vesselorganic_potions",
          "potions/d10vesselimprovised_potions",
          "potions/d10vesselnotbottle_potions",
        ],
        sub_rolls: [
          "potions/gateside_potions",
          "potions/gatebrewer_potions",
          "potions/gatesediment_potions",
          "potions/gatemislabelled_potions",
          "potions/gateinteraction_potions",
          "potions/gatedelayed_potions",
          "potions/gatecraving_potions",
          "potions/gatewanted_potions",
          "potions/gatealive_potions",
          "potions/gatetruth_potions",
        ],
      },
      {
        title: "Random Scroll",
        use:
          "A whole scroll from one click: what it is written on, in whose hand, in what ink, what the working actually does and what reading it costs. Margins, flaws, hidden text, wards, curses, seekers and stranger things arrive by chance. Most scrolls are one sheet of somebody's bad afternoon. A few are awake.",
        main_rolls: [
          "scrolls/d12script_scrolls",
          "scrolls/d20hand_scrolls",
          "scrolls/d20ink_scrolls",
          "scrolls/d12keeping_scrolls",
          "scrolls/d12condition_scrolls",
          "scrolls/d30working_scrolls",
          "scrolls/d12requires_scrolls",
          "scrolls/d16asread_scrolls",
          "scrolls/d10afterwards_scrolls",
          "scrolls/d12worth_scrolls",
          "scrolls/d16provenance_scrolls",
        ],
        pick_rolls: [
          "scrolls/d12formparchment_scrolls",
          "scrolls/d10formfolded_scrolls",
          "scrolls/d10formnotpaper_scrolls",
          "scrolls/d10formworn_scrolls",
          "scrolls/d10formcase_scrolls",
          "scrolls/d12formhaste_scrolls",
        ],
        sub_rolls: [
          "scrolls/gatemargin_scrolls",
          "scrolls/gateflaw_scrolls",
          "scrolls/gatewarning_scrolls",
          "scrolls/gateset_scrolls",
          "scrolls/gatehidden_scrolls",
          "scrolls/gateward_scrolls",
          "scrolls/gatecurse_scrolls",
          "scrolls/gatewanted_scrolls",
          "scrolls/gateawake_scrolls",
          "scrolls/gatetruth_scrolls",
        ],
      },
      {
