...
top.wilderness = [
  ...
  },
  {
    ...
    id: "d100domesticcreaturescreaturesuniquetothiscontinentincluderoll2d4times_continent",
    roll: [
      "Monkeys",
      "Apes",
      "Baboons",
  ...
  },
  {
    ...
    id: "d100foreigncreaturescreaturesimportedtothiscontinentincluderoll1d4times_continent",
    roll: [
      "Monkeys",
      "Apes",
      "Baboons",
  ...
  },
  {
    ...
    id: "d100domesticplantsplantsuniquetothiscontinentincluderoll2d4times_continent",
    roll: [
      "Roses",
      "Ferns",
      "Pine Trees",
  ...
  },
  {
    ...
    id: "d100foreignplantsplantsimportedtothiscontinentincluderoll1d4times_continent",
    roll: [
      "Roses",
      "Ferns",
      "Pine Trees",
  ...
  {
    title: "d12 Temperature: Today the air is...",
    id: "d12temperaturetodaytheairis_weather",
    roll: [
      "frigid; unprotected skin numbs in minutes.",
      "bitterly cold.",
      "cold.",
      "chilly.",
      "cool and crisp.",
      ...
      "hot.",
      "sweltering.",
      "scorching; the ground shimmers with heat.",
      "strange for the season (roll again, then flip it to the opposite extreme).",
    ],
  },
  {
    title: "d10 Wind strength: The wind is...",
    id: "d10windstrengththewindis_weather",
    roll: [
      "dead calm; smoke rises straight up.",
      "a faint breath, barely felt on the skin.",
      "a light breeze that stirs leaves and loose hair.",
      "a steady breeze; banners ripple.",
      "brisk; loose papers and dry leaves scatter.",
      "gusty, tugging at cloaks and hat brims.",
      "strong; small branches sway and campfires gutter.",
      "howling; walking against it takes real effort.",
      "a gale; small trees bend and shutters bang.",
      "a screaming windstorm; branches snap and tents tear loose.",
    ],
  },
  {
    title: "d8 Wind behavior: The wind...",
    id: "d8windbehaviorthewind_weather",
    roll: [
      "holds steady from one quarter all day.",
      "shifts direction every few hours.",
      "swirls in unpredictable eddies.",
      "arrives in sudden bursts between long lulls.",
      "carries the smell of coming rain.",
      "carries dust, grit, or dry leaves.",
      "funnels hard along valleys, streets, or corridors of trees.",
      "dies at dusk and rises again at dawn.",
    ],
  },
  {
    title: "d12 Precipitation: Falling from the sky is...",
    id: "d12precipitationfallingfromtheskyis_weather",
    roll: [
      "nothing at all.",
      "nothing, though distant clouds threaten.",
      "a clinging mist.",
      "a fine drizzle.",
      "scattered showers that come and go.",
      "steady rain.",
      "a drenching downpour.",
      "a crackling thunderstorm.",
      "hail the size of pebbles (d6): 1. for a minute; 2. for a few minutes; 3. on and off for an hour; 4. for an hour; 5. for hours; 6. hail the size of eggs, briefly.",
      "sleet that coats everything in slush.",
      "gentle snow.",
      "heavy, wind-driven snow.",
    ],
  },
  {
    title: "d10 Sky: Overhead you see...",
    id: "d10skyoverheadyousee_weather",
    roll: [
      "a cloudless, brilliant sky.",
      "a few thin, high streaks of cloud.",
      "scattered puffy clouds drifting slowly.",
      "broken clouds whose shadows race across the land.",
      "a high, flat gray ceiling.",
      "low, heavy clouds that seem near enough to touch.",
      "towering thunderheads building on the horizon.",
      "a dark, bruised sky that turns day to dusk.",
      "fast-moving shreds of cloud on a strong high wind.",
      "fog pressing down; the sky is simply gone.",
    ],
  },
  {
    title: "d12 A touch of weather flavor...",
    id: "d12atouchofweatherflavor_weather",
    roll: [
      "a vivid rainbow arcs across the sky.",
      "a pale ring circles the sun or moon.",
      "distant thunder rolls, though no storm is in sight.",
      "a wall of fog creeps in over the course of an hour.",
      "the air smells sharply of ozone.",
      "birds have gone completely, eerily silent.",
      "a sudden temperature drop raises gooseflesh.",
      "sunbeams break through the clouds in dramatic shafts.",
      "a dust devil or leaf-whirl dances across your path.",
      "the sunset (or sunrise) burns an unusual color.",
      "st. elmo's fire glimmers on high points of metal.",
      "the weather flips completely within the span of an hour.",
    ],
  },
];
